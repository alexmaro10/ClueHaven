<?php
    ...
    $sql = "SELECT TIME(fecha) AS hora FROM reservas WHERE DATE(fecha)='$fecha' AND sala_id='$id_sala' AND id != '$id_reserva'";
    ...
    echo "<input name='edit' type='hidden' value='".$id_reserva."'>";
